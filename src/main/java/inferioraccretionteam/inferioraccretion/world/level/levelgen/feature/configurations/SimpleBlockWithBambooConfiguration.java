...
public record SimpleBlockWithBambooConfiguration(float bambooProbability, BlockStateProvider toPlace) implements FeatureConfiguration
{
	public static final Codec<SimpleBlockWithBambooConfiguration> CODEC = RecordCodecBuilder.create((instance) ->
			instance.group(
					Codec.floatRange(0.0F, 1.0F).fieldOf("bambooProbability")
							.forGetter((configuration) -> configuration.bambooProbability),
